...
const TreePage = () => {
  ...
  const copyEmail = () => {
    const a = ['hello', 'brixton', 'zip'];
    const addr = `${a[0]}@${a[1]}.${a[2]}`;
      ...
      <div className="box">
        <div className="tree-container">
          ...
          <div className="links">
            ...
            <a className="link-button" onClick={copyEmail} style={{ cursor: 'pointer' }}>
              <span className="link-icon">
                <svg xmlns="http://www.w3.org/2000/svg" width="18" height="18" viewBox="0 0 24 24">
                  <path fill="currentColor" d="M20 4H4c-1.1 0-2 .9-2 2v12c0 1.1.9 2 2 2h16c1.1 0 2-.9 2-2V6c0-1.1-.9-2-2-2zm0 4l-8 5l-8-5V6l8 5l8-5v2z"/>
                </svg>
              </span>
              <span className="link-title">{copied ? 'Copied!' : 'Copy E-mail'}</span>
            </a>
          </div>
        </div>
      </div>
